...
public class TramEventHandler implements PersonEntersVehicleEventHandler, ActivityEndEventHandler {
    ...
    Map<Coord, List<String>> coordToFacilityMap = Map.ofEntries(
    ...
    public void handleEvent(ActivityEndEvent activityEndEvent) {
        if(coordToFacilityMap.containsKey(activityEndEvent.getCoord())){
            facilityCounter++;
            ...
            String stopFacility = coordToFacilityMap.get(activityEndEvent.getCoord()).get(index);
    ...
    void printCounter() throws FileNotFoundException {
        ...
        File csvOutput = new File("src\\main\\resources\\analysis\\tripsPerFacilities.csv");
